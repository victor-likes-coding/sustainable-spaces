        ...
        <main className="px-2 h-full flex flex-col gap-4 pb-8">
          <div className="max-w-3xl mx-auto p-4">
            ...
            <p className="my-4">
              ...
              Company Name] (&quot;us,&quot; &quot;we,&quot; or
              &quot;our&quot;).
            </p>

            <p>
              By accessing or using the Service, you agree to be bound by these
              Terms. If you disagree with any part of these Terms, do not use
              the Service.
            </p>
            ...
            <ol className="list-decimal ml-6">
              ...
              <li className="mb-2">
                ...
                and intellectual property rights on the Service are owned by us
                or our licensors.
              </li>
              <li className="mb-2">
                <strong>Third-Party Links:</strong> The Service may contain
                ...
                and agree that we shall not be responsible or liable, directly
            ...
            <ol className="list-decimal ml-6">
              ...
              <li className="mb-2">
                ...
                terminate the Service or these Terms at any time, without
                notice. You agree that we shall not be liable to you or any
                third party for any modification, suspension, or termination of
            ...
            <p className="text-sm">
              <strong>Updates:</strong> We reserve the right to revise these
              Terms and Conditions at any time. By continuing to access or use
              the Service after those revisions become effective, you agree to
