      ...
      <div className="w-full h-without-nav-auto bg-primary text-white">
        <main className="px-8 h-full flex flex-col gap-4 pb-8">
          ...
          <p className="text-md">
            ...
            vital services such as tenant screening, background checks,
            efficient rent collection, and facilitating the buying and selling
            of properties within our community.
          </p>

          <p>
            To make our low-cost rental options a reality, we utilize a unique
            crowdfunding approach, pooling resources from our users. Coupled
            with creative financing and other innovative tools, we can directly
