      ...
      <div className="w-full h-without-nav-auto bg-custom-primary text-white">
        <main className="px-4 h-full flex flex-col gap-4 pb-8 pt-4">
          ...
          <p>
            ...
            and shares personal information when you use our [website/mobile
            app/service] (the &quot;Service&quot;). By accessing or using the
          ...
          <ul className="flex gap-2 flex-col">
            ...
            <li>
              <strong>User-Generated Content:</strong> Any content you
              voluntarily provide, such as comments, reviews, or other
              user-generated content on the Service.
            </li>
          </ul>
          ...
          <ul className="flex gap-2 flex-col">
            <li>
              ...
              type, operating system, pages viewed, and the date and time of
              your visit.
            </li>
            <li>
              <strong>Cookies and Tracking Technologies:</strong> We use
              cookies, web beacons, and similar tracking technologies to collect
              information about your browsing and usage patterns. You can
          ...
          <ul className="list-disc ml-4">
            ...
            <li>
              To prevent fraud, protect our legal rights, and ensure the
          ...
          <p>
            ...
            regulatory reasons. Any updates will be posted on this page with a
